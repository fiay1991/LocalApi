...
import com.park.localapi.service.impl.UpLoadImageServiceImpl;

@Controller
public class UpLoadImageController {
	
	@Resource(name="upLoadImageServiceImpl")
	...
	public String uploadfile(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			String result = upLoadImageServiceImpl.upLoadImage(parmasMap);
			return result;
		} catch (Exception e) {
